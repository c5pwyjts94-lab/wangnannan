...
train_df = pd.read_csv(r"TASK2\data\train_standardized.csv")
test_df = pd.read_csv(r"TASK2\data\test_standardized.csv")
...
or_df.to_csv(
    r"TASK2\data\Logistic_OR_Table.csv",
    index=False,
    encoding="utf-8-sig"
)
...
plt.savefig(
    r"TASK2\picture-task2\logistic_OR_Analysis.png",
    format="png",
    bbox_inches="tight"
)
