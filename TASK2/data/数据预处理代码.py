...
DATA_PATH = r'TASK2\data\heart_failure_clinical_records_dataset.csv'
# 预处理后数据集保存路径
OUTPUT_CSV_PATH = r'TASK2\data\heart_failure_preprocessed_dataset.csv'
OUTPUT_EXCEL_PATH = r'TASK2\data\heart_failure_preprocessed_dataset.xlsx'
# 可视化图表保存文件夹
FIG_SAVE_DIR = r'TASK2\picture-task2'
