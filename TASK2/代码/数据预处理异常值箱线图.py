...
# ===================== 路径配置（和你本地文件对应） =====================
RAW_CSV = "TASK2\heart_failure_clinical_records_dataset.csv"
PRE_CSV = "TASK2\heart_failure_preprocessed_dataset.csv"
FIG_DIR = "preprocessing_visualization"
...
# 保存高清图片
save_path = f"{FIG_DIR}/boxplot_compare_before_after.png"
