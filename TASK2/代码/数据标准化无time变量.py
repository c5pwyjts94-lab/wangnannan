...
# 1. 读取数据 (请确保文件名和路径正确)
file_path = 'TASK2\withouttimeheart_failure_preprocessed_dataset.csv'
...
# 7. 导出为 CSV 文件
train_processed.to_csv('train_standardized.csv', index=False)
test_processed.to_csv('test_standardized.csv', index=False)
