...
欢迎加入团队！这是一份专为新成员打造的大模型与科研基础设施快速上手指南，同时也是你完成**医疗大模型挑战作业（中期挑战任务）**的综合实战仓库。

我们以大模型技术为核心。工具只是手段，**学会与大模型高效协作、用大模型驱动做事**才是我们的核心目标。建议按照指南顺序推进，并在实战任务中融会贯通。
